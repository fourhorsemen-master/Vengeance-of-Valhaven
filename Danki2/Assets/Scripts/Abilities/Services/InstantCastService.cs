...
public class InstantCastService : AbilityService
{
    ...
    )
    {
        ...
        if (!AbilityMetadataLookup.Instance.TryGetInstantCast(abilityReference, actor, GetAbilityDataDiff(abilityReference), out InstantCast instantCast)) return false;
