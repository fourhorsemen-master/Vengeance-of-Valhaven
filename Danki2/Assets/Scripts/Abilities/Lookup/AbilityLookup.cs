...
public class AbilityLookup : Singleton<AbilityLookup>
{
    ...
    private readonly AbilityMap<AbilityVocalisationType> abilityVocalisationType = new AbilityMap<AbilityVocalisationType>();
    ...
    )
    {
        if (instantCastBuilderMap.ContainsKey(abilityReference))
        {
            ...
            AbilityConstructionArgs args = new AbilityConstructionArgs(
                owner,
                abilityData,
                abilityVocalisationType[abilityReference],
    ...
    private void BuildMetadataLookups()
    {
        EnumUtils.ForEach<AbilityReference>(ability =>
        {
            ...
            abilityVocalisationType[ability] = serializableAbilityMetadata.AbilityVocalisationType;
