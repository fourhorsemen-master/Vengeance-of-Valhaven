...
[CustomEditor(typeof(AbilityLookup3))]
public class AbilityLookup3Editor : Editor
{
    private Dictionary<SerializableGuid, bool> foldoutStatus;
    
    private AbilityLookup3 abilityLookup;

    public override void OnInspectorGUI()
    {
        abilityLookup = (AbilityLookup3) target;
    ...
    private void AddAbilityButton()
    {
        if (GUILayout.Button("Add Ability"))
        {
            ...
            abilityLookup.abilityEmpowermentsDictionary[abilityId] = new EmpowermentsWrapper2();
