...
public class ComboManager
{
	...
	public ComboManager(Player player, AbilityAnimationListener abilityAnimationListener, Subject updateSubject)
	{
		workflow = new ObservableWorkflow<ComboState>(ComboState.ReadyAtRoot, updateSubject)
			...
			.WithProcessor(ComboState.ShortCooldown, new AwaitAbilityCopmletionProcessor(player, abilityAnimationListener))
