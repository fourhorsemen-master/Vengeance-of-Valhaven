...
public class BearAi : Ai
{
    ...
    protected override IStateMachineComponent BuildStateMachineComponent()
    {
        ...
        IStateMachineComponent attackStateMachine = new StateMachine<AttackState>(AttackState.ChooseAbility)
            ...
            .WithComponent(AttackState.TelegraphSwipe, new TelegraphAttack(bear, swipeDelay, Color.red))
            .WithComponent(AttackState.TelegraphMaul, new TelegraphAttack(bear, maulDelay, Color.green))
            .WithComponent(AttackState.TelegraphCleave, new TelegraphAttack(bear, cleaveDelay, Color.yellow))
        ...
        return new StateMachine<State>(State.Idle)
            ...
            .WithComponent(State.TelegraphCharge, new TelegraphAttack(bear, chargeDelay, Color.blue))
